...
from lib.openstack.nova import update_server_metadata
from lib.openstack.nova import overwrite_server_metadata
...
class UserBehavior(baseTaskSet):
    ...
    @task(4)
    def nova_update_server_metadata(self):
        update_server_metadata(self)

    @task(4)
    def nova_overwrite_server_metadata(self):
        overwrite_server_metadata(self)
