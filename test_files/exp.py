...
class UserBehavior(baseTaskSet):
    ...
    def nova_create_server(self):
        ...
        self.nova_resize_server(server_id)
        time.sleep(random.choice([1,
                                  3,
                                  5,5,5,5,5,
                                  7,7,7,7,7,7,7,7,
                                  10,10,10,10,10,
                                  25,25,25]))
        self.nova_delete_server(server_id)


    #@task(2)
    def nova_resize_server(self, server_id=None):
        #server_id = nova_get_server_id(self)
        flavor_id = random.choice([9999, 9998, 451, 
                                   9999, 9999, 9999, 9999,
                                   9998, 9998, 9998, 9998,
                                   451, 451, 451])
        ...
        if server_id:
            ...
            time.sleep(random.choice([1,3,3,3,5,5,5,5,5,10,10,10,10,10,10,10,25]))
